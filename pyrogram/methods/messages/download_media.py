...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            ...
            no_temp (``bool``, *optional*):
                Pass True to write directly to the final path instead of using a temporary ``.temp`` file.
                Defaults to False, which keeps the original safe atomic rename behavior.
        ...
        downloader = self.handle_download(
            (file_id_obj, directory, file_name, in_memory, file_size, progress, progress_args, no_temp)
        )
